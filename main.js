...
var kingW = { color: "white", type: "king", img: "img/wking.png", location: ''};
    ...
    for (var i = 0; i < boardArray.length; i++){
      ...
      for (var j = 0; j < boardArray.length; j++){
        ...
        if (i === 0){
          ...
          $td.setAttribute('data-location', '[0, ' + j + ']');
          // $td.setAttribute('data-location', 'H' + [j+1]);
        } else if (i === 1) {
          // append $td with ID of B[j+1]
          $td.setAttribute('data-location', '[1, ' + j + ']');
        } else if (i === 2) {
          // append $td with ID of C[j+1]
          $td.setAttribute('data-location', '[2, ' + j + ']');
        } else if (i === 3) {
           $td.setAttribute('data-location', '[3, ' + j + ']');
        } else if (i === 4) {
           $td.setAttribute('data-location', '[4, ' + j + ']');
        } else if (i === 5) {
           $td.setAttribute('data-location', '[5, ' + j + ']');
        } else if (i === 6) {
           $td.setAttribute('data-location', '[6, ' + j + ']');
        } else if (i === 7) {
           $td.setAttribute('data-location', '[7, ' + j + ']');
        }
      }
    }
  }
...
$( 'td' ).click(function(){
  ...
  var $A5 = document.querySelector.data('A5');
